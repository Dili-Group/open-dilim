...
| 12 | [SSE đồng bộ dealer-customer](./architecture/12-dealer-customer-sse.md) | Route `POST /agent/dealer-customer` cho sale-widget: vì sao không qua gateway, sink SSE, mã lỗi, core phải đổi gì |

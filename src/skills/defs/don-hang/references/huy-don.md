...
4. Ghi lại rõ trong câu trả lời: **mã vận đơn + lý do khách nêu** — nhân viên trong nhóm đọc là xử lý
...
| Trạng thái | Trả lời |
|---|---|
| bản nháp / đơn hàng mới / đã kiểm duyệt | Đơn chưa vào kho, khả năng huỷ cao. Ghi nhận + chuyển vận hành xử lý. |
| đang soạn hàng / đã soạn xong | Còn kịp hay không do kho quyết. Ghi nhận + chuyển vận hành, KHÔNG hứa chắc huỷ được. |
| đã quét xuất kho / đã bàn giao ĐVVC / đang vận chuyển | Hàng đã rời kho — huỷ lúc này thành **hoàn hàng**, không phải huỷ đơn. Nói rõ khác biệt đó rồi chuyển vận hành. Quy trình hoàn: skill `refund`. |
| giao thành công / giao một phần | Không huỷ được nữa. Nếu khách muốn trả hàng → skill `refund`. |
| đang hoàn hàng / hoàn thành công tại kho | Đơn đang/đã quay về kho rồi, không còn gì để huỷ. Chuyển vận hành nếu khách hỏi tiền. |

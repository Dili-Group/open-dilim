...
**Vẫn được phép nhiều mã số** trong một hộ gia đình, với điều kiện các mã số đều có **hoạt động
kinh doanh thực chất**.

**Định nghĩa:** "mã số có quan hệ lợi ích" = các mã số có quan hệ lợi ích mật thiết (ví dụ:
vợ/chồng, cha mẹ/con cái) **VÀ** cùng nằm trong một tuyến bảo trợ.

### Quy định riêng về hoa hồng

Để nhận hoa hồng phát sinh từ mã số có quan hệ lợi ích nằm ở **tuyến dưới**, mã số **tuyến trên**
phải đạt doanh thu xét thưởng riêng **từ 100.000.000 đ/tháng**.

Ví dụ trong văn bản — chồng tuyến trên, vợ tuyến dưới, cùng một nhánh:

| Tình huống | Kết quả |
|---|---|
| Chồng 100 triệu/tháng, vợ 100 triệu/tháng | chồng **được** nhận hoa hồng từ nhánh của vợ |
| Chồng 60 triệu, vợ 150 triệu | chồng **không** được nhận hoa hồng từ doanh số của vợ |

**Trong mọi trường hợp, hoa hồng từ các nhánh kinh doanh độc lập khác vẫn tính bình thường** — chỉ
nhánh có quan hệ lợi ích bị chặn.

**Mục tiêu của điều này** (nói được với đại lý): không cấm người thân cùng kinh doanh, mà để loại bỏ
lợi ích của việc chia tách đội nhóm chỉ nhằm tối ưu hoa hồng.

Mức doanh thu áp dụng cụ thể có thể được **Ban Giám đốc điều chỉnh bằng văn bản** theo từng thời kỳ.

### Cách nói — đây là chủ đề nhạy cảm

- Nói bằng **giọng quy định chung**, dẫn đúng điều khoản và mục tiêu.
- **Không** suy đoán quan hệ gia đình của bất kỳ ai, **không** hỏi dò quan hệ, **không** nhận xét ai
...
- gian lận số liệu,
- bán phá giá,
- tạo đơn ảo để lách chính sách,
- vi phạm nghiêm trọng Bộ Quy tắc ứng xử của DiLiM.

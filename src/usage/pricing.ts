...
//  - Token rẻ nhất ($0,0028/1M = 2,8e-9 USD/token) chỉ ra số nguyên từ mức pico trở xuống;
 ...
 *
 * $0,0028 / 1M token = 2,8e-9 USD/token = 2800 pico.
 */
const PICO_PER_CACHE_READ = 2_800; // $0,0028 / 1M — cache hit
const PICO_PER_INPUT = 130_000; // $0,13   / 1M — cache miss
const PICO_PER_OUTPUT = 240_000; // $0,24   / 1M
